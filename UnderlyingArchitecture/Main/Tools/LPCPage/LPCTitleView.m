...
//        label.textColor = i == 0 ? [UIColor colorWithHex:0x29A9FF] : [UIColor colorWithHex:0x333333];
...
- (void)setupTitleLabelFrame{
    ...
    {
        titleW = self.frame.size.width / 4.5;
...
//    currentLabel.textColor = [UIColor colorWithHex:0x29A9FF];
//    oldLabel.textColor = [UIColor colorWithHex:0x333333];
    //保存最新Label的下标值
...
//    sourceLabel.textColor = [UIColor colorWithHex:0x29A9FF];
//    targetLabel.textColor = [UIColor colorWithHex:0x333333];
